...
class IStockRepository(ABC):
    ...
    @abstractmethod
    async def increment(self, product_id: int, warehouse_id: int, qty: int, tenant_id: int) -> Stock: ...

    @abstractmethod
    async def decrement(self, product_id: int, warehouse_id: int, qty: int, tenant_id: int) -> Stock: ...

    @abstractmethod
    async def set_quantity(self, product_id: int, warehouse_id: int, quantity: int, tenant_id: int) -> Stock: ...
...
class ITransactionRepository(ABC):
    @abstractmethod
    async def record(
        self, tenant_id: int, operation_id: int, product_id: int, warehouse_id: int,
        type: TransactionType, quantity: int,
