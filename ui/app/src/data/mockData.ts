...
export const transactions: InventoryTransaction[] = [
    { id: 1, tenantId: 1, productId: 1, userId: 1, warehouseId: 1, destWarehouseId: null, type: 'In', quantity: 50, note: 'Initial restocking from Apple supplier', timestamp: '2026-03-02T08:30:00Z', productName: 'iPhone 15 Pro', userName: 'Alex Johnson', warehouseName: 'Warehouse Alpha' },
    { id: 2, tenantId: 1, productId: 1, userId: 2, warehouseId: 1, destWarehouseId: null, type: 'Out', quantity: 8, note: 'Sold to retail outlet #3', timestamp: '2026-03-02T09:15:00Z', productName: 'iPhone 15 Pro', userName: 'Sarah Chen', warehouseName: 'Warehouse Alpha' },
    { id: 3, tenantId: 1, productId: 1, userId: 1, warehouseId: 1, destWarehouseId: 2, type: 'Transfer', quantity: 18, note: 'Moving stock to Beta warehouse', timestamp: '2026-03-01T14:00:00Z', productName: 'iPhone 15 Pro', userName: 'Alex Johnson', warehouseName: 'Warehouse Alpha', destWarehouseName: 'Warehouse Beta' },
    { id: 4, tenantId: 1, productId: 3, userId: 3, warehouseId: 1, destWarehouseId: null, type: 'In', quantity: 10, note: 'Quarterly laptop restock', timestamp: '2026-03-01T10:00:00Z', productName: 'MacBook Pro 16"', userName: 'Marcus Williams', warehouseName: 'Warehouse Alpha' },
    { id: 5, tenantId: 1, productId: 3, userId: 2, warehouseId: 1, destWarehouseId: null, type: 'Out', quantity: 7, note: 'Corporate bulk order', timestamp: '2026-02-28T16:30:00Z', productName: 'MacBook Pro 16"', userName: 'Sarah Chen', warehouseName: 'Warehouse Alpha' },
    { id: 6, tenantId: 1, productId: 5, userId: 1, warehouseId: 1, destWarehouseId: null, type: 'In', quantity: 30, note: 'Restock from distributor', timestamp: '2026-02-28T11:00:00Z', productName: 'AirPods Pro 2', userName: 'Alex Johnson', warehouseName: 'Warehouse Alpha' },
    { id: 7, tenantId: 1, productId: 5, userId: 3, warehouseId: 1, destWarehouseId: null, type: 'Out', quantity: 25, note: 'Flash sale orders fulfilled', timestamp: '2026-02-27T09:00:00Z', productName: 'AirPods Pro 2', userName: 'Marcus Williams', warehouseName: 'Warehouse Alpha' },
    { id: 8, tenantId: 1, productId: 7, userId: 4, warehouseId: 2, destWarehouseId: null, type: 'In', quantity: 5, note: 'New furniture arrival', timestamp: '2026-02-27T13:00:00Z', productName: 'Standing Desk Pro', userName: 'Priya Patel', warehouseName: 'Warehouse Beta' },
    { id: 9, tenantId: 1, productId: 7, userId: 5, warehouseId: 2, destWarehouseId: null, type: 'Out', quantity: 3, note: 'Office renovation order', timestamp: '2026-02-26T15:00:00Z', productName: 'Standing Desk Pro', userName: 'James Lee', warehouseName: 'Warehouse Beta' },
    { id: 10, tenantId: 1, productId: 9, userId: 2, warehouseId: 1, destWarehouseId: 2, type: 'Transfer', quantity: 80, note: 'Redistribute paper stock', timestamp: '2026-02-26T10:00:00Z', productName: 'A4 Copy Paper', userName: 'Sarah Chen', warehouseName: 'Warehouse Alpha', destWarehouseName: 'Warehouse Beta' },
    { id: 11, tenantId: 1, productId: 2, userId: 1, warehouseId: 3, destWarehouseId: null, type: 'In', quantity: 30, note: 'Samsung shipment received', timestamp: '2026-02-25T08:00:00Z', productName: 'Samsung Galaxy S24', userName: 'Alex Johnson', warehouseName: 'Warehouse Gamma' },
    { id: 12, tenantId: 1, productId: 2, userId: 3, warehouseId: 3, destWarehouseId: null, type: 'Out', quantity: 5, note: 'Online marketplace fulfillment', timestamp: '2026-02-25T14:30:00Z', productName: 'Samsung Galaxy S24', userName: 'Marcus Williams', warehouseName: 'Warehouse Gamma' },
    { id: 13, tenantId: 1, productId: 10, userId: 5, warehouseId: 1, destWarehouseId: null, type: 'Out', quantity: 15, note: 'School supply donation', timestamp: '2026-02-24T09:00:00Z', productName: 'Gel Pen Set', userName: 'James Lee', warehouseName: 'Warehouse Alpha' },
    { id: 14, tenantId: 1, productId: 12, userId: 4, warehouseId: 3, destWarehouseId: null, type: 'In', quantity: 8, note: 'Dell shipment received', timestamp: '2026-02-24T11:00:00Z', productName: 'Dell XPS 15', userName: 'Priya Patel', warehouseName: 'Warehouse Gamma' },
    { id: 15, tenantId: 1, productId: 12, userId: 2, warehouseId: 3, destWarehouseId: null, type: 'Out', quantity: 4, note: 'Engineering team upgrade', timestamp: '2026-02-23T16:00:00Z', productName: 'Dell XPS 15', userName: 'Sarah Chen', warehouseName: 'Warehouse Gamma' },
];
